        ...
        >
            ...
            <motion.div variants={item} className="mt-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                        ...
                        className="flex items-center px-4 py-2 bg-[#101F3C] text-white rounded-lg text-sm font-bold hover:bg-blue-900 transition-colors shadow-lg shadow-blue-900/20"
                    >
                                ...
                                return (
                                    <tr key={user._id} className="group hover:bg-gray-50 transition-colors">
                                        <td className="py-4 pl-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${isSuperAdmin ? "bg-[#101F3C] text-white" : "bg-orange-100 text-orange-600"}`}>
                        ...
                        {!createdUserPassword ? (
                            <form onSubmit={async (e) => {
                                ...
                                <div className="space-y-4">
                                    ...
                                    <button type="submit" className="w-full bg-[#101F3C] text-white py-3 rounded-xl font-bold hover:bg-blue-900 transition-colors mt-4">
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <div className="bg-gray-100 p-4 rounded-xl border border-gray-200 flex items-center justify-between mt-2">
                                    <code className="text-lg font-mono font-bold text-[#101F3C]">{createdUserPassword}</code>
                                    <button
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl animate-fade-in-up text-center">
                        ...
                        <div className="bg-gray-100 p-4 rounded-xl border border-gray-200 flex items-center justify-between mb-6">
                            <code className="text-lg font-mono font-bold text-[#101F3C]">{resetUserPassword.password}</code>
                            <button
                        ...
                        <button
                            ...
                            className="w-full bg-[#101F3C] text-white py-3 rounded-xl font-bold hover:bg-blue-900 transition-colors"
                        >
                            Close
                        </button>
                    </div>
            ...
            <div className="mt-8 flex justify-end">
                <button
                    onClick={handleSave}
                    disabled={isLoading}
                    className="flex items-center px-8 py-4 bg-[#101F3C] text-white rounded-xl font-bold hover:bg-[#0F172A] shadow-lg shadow-blue-900/20 transition-all disabled:opacity-70 disabled:cursor-not-allowed transform hover:-translate-y-1"
                >
                    {isLoading ? (
