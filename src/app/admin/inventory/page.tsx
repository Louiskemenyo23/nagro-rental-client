...
export default function InventoryPage() {
    ...
    const categories = ["All", "Chairs", "Tents", "Tables", "Lighting", "Backdrops", "Flooring", "Decor"];
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <button className="p-1.5 text-gray-400 hover:text-red-500 rounded-md transition-colors">
                                                        <Trash2 size={16} />
                                                    </button>
                                                </div>
                                            </td>
